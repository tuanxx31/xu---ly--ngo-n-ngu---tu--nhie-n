...
TOPIC_CONFIG = {
    "Công nghệ": {
        "keywords": {
            ...
            "kỹ thuật số": 1.5,
            "linh kiện": 1.2,
            "công nghệ thông tin": 1.8,
        },
        "strong_phrases": {
            "trí tuệ nhân tạo": 3.0,
            "cơ sở dữ liệu": 3.0,
            "điện toán đám mây": 3.0,
            "bảo mật thông tin": 3.0,
            "công nghệ số": 3.0,
            "tự động hóa": 3.0,
            "hệ thống phần mềm": 3.0,
            "lập trình python": 3.0,
            "an ninh mạng": 3.0,
            "công nghệ blockchain": 3.0,
            "chuyển đổi số": 3.0,
            "phát triển ứng dụng": 3.0,
        },
        "context_boost": {
            "phrase_bonus": [
                {"phrases": ["trí tuệ nhân tạo", "cơ sở dữ liệu"], "score": 1.8},
                {
                    "phrases": ["điện toán đám mây", "an ninh mạng", "chuyển đổi số"],
                    "score": 1.5,
                },
    ...
    "Giáo dục": {
        ...
        "strong_phrases": {
            "học trực tuyến": 3.0,
            "bài giảng online": 3.0,
            "kỳ thi cuối kỳ": 3.0,
            "lớp học": 3.0,
            "bài giảng": 3.0,
            "phương pháp giảng dạy": 3.0,
            "chương trình đào tạo": 3.0,
            "môi trường học tập": 3.0,
            "tuyển sinh đại học": 3.0,
            "phát triển kỹ năng": 3.0,
            "đổi mới giáo dục": 3.0,
        },
        "context_boost": {
            "phrase_bonus": [
                {"phrases": ["học trực tuyến", "bài giảng online"], "score": 1.8},
                {
                    "phrases": ["phương pháp giảng dạy", "chương trình đào tạo"],
                    "score": 1.5,
                },
    ...
    "Sức khỏe": {
        ...
        "strong_phrases": {
            ...
            "sức đề kháng": 3.0,
            "giấc ngủ": 3.0,
            "bác sĩ chuyên khoa": 3.0,
            "phác đồ điều trị": 3.0,
            "khám bệnh định kỳ": 3.0,
            "chăm sóc sức khỏe": 3.0,
            "phòng chống dịch bệnh": 3.0,
            "lối sống lành mạnh": 3.0,
        },
        "context_boost": {
            "phrase_bonus": [
                ...
                {
                    "phrases": ["phòng chống dịch bệnh", "bác sĩ chuyên khoa"],
                    "score": 1.3,
                },
            ],
            "keyword_combo": [
    ...
    "Thể thao": {
        ...
        "strong_phrases": {
            ...
            "đội bóng": 3.0,
            "vận động viên": 3.0,
            "chiến thuật pressing": 3.0,
            "đội hình thi đấu": 3.0,
            "giải ngoại hạng": 3.0,
            "tinh thần thể thao": 3.0,
            "thành tích thi đấu": 3.0,
        },
        "context_boost": {
            "phrase_bonus": [
    ...
    "Kinh tế": {
        ...
        "strong_phrases": {
            "thị trường chứng khoán": 3.0,
            "tăng trưởng kinh tế": 3.0,
            "chính sách tiền tệ": 3.0,
            "lãi suất ngân hàng": 3.0,
            "tỷ giá ngoại tệ": 3.0,
            "cán cân thương mại": 3.0,
            "đầu tư nước ngoài": 3.0,
            "ngân sách nhà nước": 3.0,
            "khởi nghiệp startup": 3.0,
            "phát triển kinh tế": 3.0,
            "quản lý tài chính": 3.0,
        },
        "context_boost": {
            "phrase_bonus": [
                {
                    "phrases": ["thị trường chứng khoán", "tăng trưởng kinh tế"],
                    "score": 1.8,
                },
    ...
    "Ẩm thực": {
        ...
        "strong_phrases": {
            "ẩm thực đường phố": 3.0,
            "nguyên liệu tươi sống": 3.0,
            "món ăn truyền thống": 3.0,
            "công thức nấu ăn": 3.0,
            "đặc sản vùng miền": 3.0,
            "nghệ thuật ẩm thực": 3.0,
            "hương vị đặc trưng": 3.0,
            "chế biến món ăn": 3.0,
            "nhà hàng cao cấp": 3.0,
            "ẩm thực vùng miền": 3.0,
            "bí quyết nấu ăn": 3.0,
        },
        "context_boost": {
            "phrase_bonus": [
    ...
    "Văn hóa - Nghệ thuật": {
        ...
        "strong_phrases": {
            "nghệ thuật đương đại": 3.0,
            "lễ hội văn hóa": 3.0,
            "di sản văn hóa": 3.0,
            "sân khấu kịch": 3.0,
            "điện ảnh việt nam": 3.0,
            "triển lãm nghệ thuật": 3.0,
            "âm nhạc truyền thống": 3.0,
            "văn hóa dân gian": 3.0,
            "tác phẩm nghệ thuật": 3.0,
            "biểu diễn nghệ thuật": 3.0,
            "văn hóa nghệ thuật": 3.0,
        },
        "context_boost": {
            "phrase_bonus": [
    ...
    "Pháp luật": {
        ...
        "strong_phrases": {
            "vi phạm pháp luật": 3.0,
            "bộ luật hình sự": 3.0,
            "quyền công dân": 3.0,
            "tòa án nhân dân": 3.0,
            "viện kiểm sát nhân dân": 3.0,
            "khởi tố vụ án": 3.0,
            "xét xử sơ thẩm": 3.0,
            "bản án tử hình": 3.0,
            "tư vấn pháp luật": 3.0,
            "quy định pháp luật": 3.0,
            "tranh chấp dân sự": 3.0,
        },
        "context_boost": {
            "phrase_bonus": [
    ...
    "Du lịch": {
        ...
        "strong_phrases": {
            "du lịch sinh thái": 3.0,
            "điểm đến du lịch": 3.0,
            "khách sạn nghỉ dưỡng": 3.0,
            "danh lam thắng cảnh": 3.0,
            "tour du lịch": 3.0,
            "hướng dẫn viên du lịch": 3.0,
            "du lịch trải nghiệm": 3.0,
            "khu nghỉ dưỡng": 3.0,
            "đặt vé máy bay": 3.0,
            "hành trình khám phá": 3.0,
            "du lịch bụi": 3.0,
        },
        "context_boost": {
            "phrase_bonus": [
                ...
                {
                    "phrases": ["hành trình khám phá", "du lịch trải nghiệm"],
                    "score": 1.3,
                },
            ],
            "keyword_combo": [
    ...
    "Xe": {
        ...
        "strong_phrases": {
            ...
            "xe bán tải": 3.0,
            "bảo dưỡng xe": 3.0,
            "xe điện thông minh": 3.0,
            "đại lý ủy quyền": 3.0,
            "công nghệ ô tô": 3.0,
            "an toàn giao thông": 3.0,
            "nội thất xe hơi": 3.0,
        },
        "context_boost": {
            "phrase_bonus": [
    ...
    "Đời sống": {
        ...
        "strong_phrases": {
            "nuôi dạy con": 3.0,
            "đời sống gia đình": 3.0,
            "chi tiêu tiết kiệm": 3.0,
            "mua sắm online": 3.0,
            "hôn nhân gia đình": 3.0,
            "cuộc sống hàng ngày": 3.0,
            "chăm sóc gia đình": 3.0,
            "trang trí nhà cửa": 3.0,
        },
        "context_boost": {
            "phrase_bonus": [
    ...
    "Bất động sản": {
        ...
        "strong_phrases": {
            "mua bán nhà đất": 3.0,
            "chung cư cao cấp": 3.0,
            "khu đô thị mới": 3.0,
            "dự án bất động sản": 3.0,
            "sổ đỏ chính chủ": 3.0,
            "giá bất động sản": 3.0,
            "căn hộ chung cư": 3.0,
            "đất nền dự án": 3.0,
        },
        "context_boost": {
