...
from topic_analysis_core import (
    APP_TITLE,
    MIN_WORDS_REQUIRED,
    SAMPLE_DATA,
    TOPICS,
    VOCABULARY,
    build_basic_python_report,
    explain_prediction,
    load_history,
    predict_topic,
    preprocess_text,
...
class TopicSuggestionApp:
    def __init__(self, root):
        ...
        self.basic_report = build_basic_python_report(self.dataset)
    ...
    def analyze_text(self):
        ...
        processed = preprocess_text(input_content)
        ...
        prediction = predict_topic(input_content)
        explanation = explain_prediction(input_content, prediction)
        self.set_result_text(self.build_result_content(prediction, explanation))
        self.save_analysis_history(input_content, prediction, explanation)

    def build_result_content(self, prediction, explanation):
    ...
    def save_analysis_history(self, input_content, prediction, explanation):
        record = {
